        ...
        <>
            <div className="relative mt-28">
                <div className="mb-16 xxxs:mx-2 md:mx-0">
                    <h3 className="text-center text-gray-500 font-bold text-2xl mb-4 md:text-4xl md:pb-4 xlg:text-4xl">Everyday needs</h3>
                ...
                <div className="flex xxs:flex-col md:px-6 md:flex-col items-center justify-center xxxs:space-y-4">
                    <div className=" bg-white p-8 rounded-2xl pl-9 md:w-full">
                        <div>
                            ...
                            <p className="py-4 text-lg w-8/12 md:text-2xl xlg:mt-4">Jeton seamlessly combines major payment providers around the world in one easy to use wallet</p>
                        </div>
