            ...
            <div className="relative">
                ...
                <div className="flex items-center flex-col space-y-4" id="card-container">
                    <div className="flex items-center justify-center space-x-4" id="card-cont-i">                        
                        <div className="bg-white w-6/12 p-4 px-6 rounded-lg shadow-lg" id="card_i">
                        ...
                        <div className="bg-white w-4/12 p-4 px-6 rounded-lg shadow-lg" id="card_i">
                            <i className="fa fa-quote-left text-gray-200 text-3xl pb-3"></i>
                    ...
                    <div className="flex items-center justify-center space-x-4" id="card-cont-i">                        
                        <div className="bg-white w-5/12 p-4 px-6 rounded-lg shadow-lg" id="card_i">
                            <i className="fa fa-quote-left text-gray-200 text-3xl pb-3"></i>
