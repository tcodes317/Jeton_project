...
function Main_vii(){
    return(
        <>
            <div className="relative mt-24 w-8/12 mx-auto">
                <div>
                ...
                <div className="relative rounded-xl p-10 mt-6 pt-20" id="iio">
                    <h1 className="text-white font-bold text-4xl w-6/12 mb-8">Every Payment Pays You Back with Jeton!</h1>
                    <h1 className="text-xl font-bold text-gray-400 w-5/12 mb-10"><span className="text-orange-400 mr-2" id="ure">Get 1% Cashback</span>reward everytime you make a payment with Jeton. Don't miss out on this offer start pampering your wallet now!</h1>
                    <h4 className="mb-12 text-white font-bold">Terms & Conditions</h4>
                    <img src={Img_i} srcset={Img_i} className="absolute z-50 w-3/12 right-0 top-0" />
