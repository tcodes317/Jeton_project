    ...
    return(
        <>
            <div className="relative mt-24 md:w-11/12 mx-auto">
                <div>
                    <h1 className="text-2xl font-bold xlg:text-4xl text-center text-gray-400 md:text-4xl">Get 1% Cashback
                        {/* <img src={} srcset={} /> */}
                    </h1>
                    <h1 className="text-center mt-4 font-bold text-3xl xlg:text-5xl xlg:py-4 md:text-4xl">Advantages of Jeton Wallet Awaits you</h1>
                </div>
                <div className="relative rounded-xl p-10 mt-6 pt-20" id="iio">
                    ...
                    <h1 className="text-xl font-bold text-gray-400 xlg:text-2xl md:w-5/12 xlg:w-6/12 mb-10"><span className="text-orange-400 mr-2" id="ure">Get 1% Cashback</span>reward everytime you make a payment with Jeton. Don't miss out on this offer start pampering your wallet now!</h1>
                    <h4 className="mb-12 text-white xlg:text-xl font-bold">Terms & Conditions</h4>
