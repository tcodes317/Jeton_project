    ...
    return(
        <>
            <div className="relative mt-32 pb-20">
                <div className="space-y-3 xxlg:space-y-6">
                    <h3 className="text-center text-2xl font-bold text-gray-500 xlg:text-3xl xxlg:text-4xl">Card meets technology</h3>
                    <h1 className="text-center text-3xl font-bold xlg:text-4xl xxlg:text-5xl">Ready to use right away</h1>
                ...
                <div className="mt-14 border-2 border-black shadow-md rounded-2xl py-4 bg-white w-8/12 mx-auto xxxs:flex-col md:flex-col flex items-center justify-center">
                    ...
                    <div className="mx-auto flex justify-center md:text-center w-12/12 xxlg:space-y-5 pl-4 flex-col text-left md:mr-5">
                        <h1 className="md:text-3xl font-bold py-4 xxxs:text-2xl xxlg:text-5xl">Get Your Jeton Card</h1>
                        <p className="w-9/12 text-2xl xxxs:text-center md:w-full md:text-center xxlg:leading-10 md:mx-auto xxxs:mx-auto">Use your Jeton Card for all purchases with ease. <br /> Whether physical or virtual, your Visa Debit card works seamlessly at all merchants and terminals accepting Visa Debit. Enjoy quick and secre payments using your everyday devices like phone or smart watch.</p>
            ...
            <div className="relative mt-2 w-8/12 mx-auto">
                <div className="flex xxxs:flex-col md:flex-col md:space-y-8 xxxs:items-center md:items-stretch">
                    ...
                    <div className="space-y-1 bg-blue-700 xxxs:mt-4 xxxs:w-full md:mt-0 xlg:text-2xl p-6 rounded-2xl text-white">
                        ...
                        <h1 className="font-bold text-4xl w-10/12 pb-6 pt-4 xlg:text-4xl xxlg:text-5xl">Faster payments, made simpler every day.</h1>
            ...
            <div className="relative mt-8">
                <div className="flex xxxs:flex-col md:flex-col items-center justify-center xxxs:space-y-4 md:space-y-6 xxxs:mx-4 xlg:mx-0">
                    <div className="bg-white p-8 rounded-xl flex md:w-8/12 items-center">
                        <div className="xxlg:space-y-6">
                            <h1 className="font-bold text-3xl text-left xlg:text-4xl xxlg:text-5xl">Easy to Pay</h1>
                            <p className="pt-5 text-xl w-7/12 md:w-9/12 md:text-xl xlg:text-2xl xxlg:text-3xl">The easiest way to pay - Jeton card contactless pay</p>
                        </div>
                        <div>
                    ...
                    <div className="bg-gray-500 p-8 py-12 md:w-8/12 rounded-xl flex items-center">
                        <div className="xxlg:space-y-6">
                            <h1 className="text-white xxlg:text-5xl font-bold text-3xl xlg:text-4xl">Stay Secure</h1>
                            <p className="text-white pt-4 w-7/12 xxlg:text-3xl md:w-9/12 md:text-xl xlg:text-2xl">From card freezing, to spending limits, turn them on or off with a single move.</p>
                        </div>
                        <div>
